...
urlpatterns = [
    ...
    path('filesets/<str:fileset_id>/files/<str:file_id>/png', file_to_png),
    path('filesets/<str:fileset_id>/files/<str:file_id>/text', file_to_text),
    path('filesets/<str:fileset_id>/files/<str:file_id>/csv', file_to_csv),
    path('tasks/', tasks),
